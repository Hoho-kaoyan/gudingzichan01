...
- `GET /api/assets/export` - 导出资产为 Excel（仅管理员）
...
2. **Excel导入**：
   ...
   - 列名必须与文档中的格式一致
   - 导入时会自动创建不存在的资产大类
   - 详细导入格式请参考 [批量导入指南](docs/开发与使用/批量导入指南.md)
...
项目文档已按类归并至 `docs/` 目录，详见 [文档索引](docs/README.md)。

**需求与设计**  
- [功能需求文档](docs/需求与设计/功能需求文档.md)  
- [功能模块说明](docs/需求与设计/功能模块说明.md)  
- [安全检查功能设计方案](docs/需求与设计/安全检查功能设计方案.md)  

**开发与使用**  
- [快速启动指南](docs/开发与使用/快速启动指南.md) - 快速启动项目  
- [开发者指南](docs/开发与使用/开发者指南.md) - 开发者快速上手指南  
- [批量导入教程](docs/开发与使用/批量导入指南.md) - Excel 批量导入数据  

**迁移与部署**  
- [内网迁移指南](docs/迁移与部署/内网迁移指南.md) - 从 SQLite 迁移到 Oracle/SQL Server（详细步骤）  
- [迁移快速参考](docs/迁移与部署/迁移快速参考.md) - 迁移关键步骤快速查找  
- [数据库配置示例](docs/迁移与部署/数据库配置示例.md) - 数据库配置快速参考  

**方案与报告**
- [文档一致性与联动安全检查实现方案](docs/方案与报告/文档一致性与联动安全检查实现方案.md) - 文档与代码一致性、联动安全检查需求与实现方案
- [常见场景与代码对照说明](docs/方案与报告/常见场景与代码对照说明.md) - 七大业务场景与现有代码对照
- [仓库用户方案分析与替代方案](docs/方案与报告/仓库用户方案分析与替代方案.md) - 仓库用户方案乙等分析与选型
- [人员A工作完成情况与人员C工作解析](docs/方案与报告/人员A工作完成情况与人员C工作解析.md) - 人员 A/B/C/D 工作完成情况与待办梳理
