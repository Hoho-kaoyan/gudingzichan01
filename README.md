...
### 核心功能
- ✅ **资产管理**：资产的增删改查、批量导入、软删除
- ✅ **资产交接**：资产从A员工转到B员工的申请流程
- ✅ **资产退回**：员工离职时资产退回仓库的申请流程
- ✅ **资产编辑申请**：普通用户修改资产信息需管理员审批
- ✅ **流程审批**：管理员审批交接、退回和编辑申请
- ✅ **资产历史记录**：完整记录资产的所有操作历史
...
- [批量导入教程](IMPORT_GUIDE.md)
- [功能模块详细说明](FEATURES.md)
