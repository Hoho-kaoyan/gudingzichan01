...
│   │   └── safety_check_auto_config.py  # 联动安全检查配置
...
│   │   │   ├── SafetyCheckTaskManagement.jsx  # 含检查类型管理、联动配置弹窗
│   │   │   ├── MySafetyCheckTasks.jsx
│   │   │   └── SafetyCheckTypeManagement.jsx  # 未挂路由，功能在任务管理页弹窗内
│   │   ├── components/        # 公共组件
...
│
├── docs/                     # 项目文档（详见 docs/README.md 索引）
│   ├── README.md             # 文档索引与归类说明
│   ├── 需求与设计/
│   ├── 开发与使用/            # 本文件所在目录
│   ├── 测试/
